...
const searchPokemons = async () => {
    ...
    search.addEventListener("input", () => {
        ...
        if (singlePokemon[0]) {
            showPokemon()
        } else if (pokemonMatches.length > 0 && !singlePokemon[0]) {
            showPokemons()
        } else {
            noPokemons()
        }
